...
- SWE-QA-Pro introduces a repository-level QA benchmark and agentic training framework for code understanding, enabling LLM to navigate, reason over, and verify real-world software repositories.
</div>
</div>

<div class='paper-box'><div class='paper-box-image'><div><div class="badge">ICLR 2026</div><img src='/images/viscoder2.png' alt="VisCoder2" width="100%"></div></div>
<div class='paper-box-text' markdown="1">
...
- VisCoder2 introduces a multi-language visualization coding benchmark, dataset, and model family, enabling language models to generate, execute, render, and iteratively debug visualization code across diverse programming languages.
</div>
</div>

<div class='paper-box'><div class='paper-box-image'><div><div class="badge">EMNLP 2024</div><img src='/images/LFTQAEval.png' alt="LFTQA" width="85%"></div></div>
<div class='paper-box-text' markdown="1">
...
- LfTQA-Eval is a meta-evaluation dataset containing 2,988 human-annotated examples, designed to evaluate the performance of current automated metrics in assessing LLM-based LFTQA systems, with an emphasis on faithfulness and comprehensiveness.
</div>
</div>
